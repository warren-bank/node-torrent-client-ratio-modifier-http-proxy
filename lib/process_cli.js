...
const state = {} // infohash: {previous: {real_dl, mock_dl, real_ul, mock_ul, boost_ul_timestamp}}
...
const process_request = (req, res, argv_vals) => {
  ...
  if (infohash) {
    ...
    if (!state[infohash])
      state[infohash] = {previous: {real_dl: 0, mock_dl: 0, real_ul: 0, mock_ul: 0, boost_ul_timestamp: 0}}
